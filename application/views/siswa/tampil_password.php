...
<?php }
?>
<form class= "form-horizontal mb-lg" enctype="multipart/form-data" method="post" action="<?php echo site_url('Spp_siswa/GantiPswd')?>">
  ...
  <div class="form-group">
    ...
    <input type="password"  minlength="6" maxlength="20"class="form-control" name="pswdb" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Password Baru">
