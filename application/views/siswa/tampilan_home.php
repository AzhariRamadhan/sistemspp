...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<link rel="shortcut icon" href="<?php echo base_url();?>assets/images/tutwurihandayani.png" />
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="<?php echo base_url();?>assets/images/smansa.png" height="35" alt="JSOFT Admin" />
					</a>
				...
				<span class="judul"> Sistem Informasi Pembayaran SPP SMAN 1 Bengkulu Tengah</span>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?php echo base_url() ?>uploads/fotosiswa/<?php echo $this->session->userdata('foto'); ?>" alt="Joseph Doe" height="35" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
							</figure>
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
								<span class="name"><?php echo $this->session->userdata('namamhs') ?></span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo base_url();?>homesiswa/logout"><i class="fa fa-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="inner-wrapper">
				...
				<?php $this->load->view('siswa/tampilan_menu'); ?>
