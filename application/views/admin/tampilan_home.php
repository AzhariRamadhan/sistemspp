...
<html class="fixed">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>assets/images/tutwurihandayani.png">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?php echo base_url();?>assets/images/admin.png" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
							</figure>
